...
fun TodoScreen(
    ...
    Column {
        ...
        LazyColumn(
            ...
            items(items = items) {
                if(currentlyEditItem?.id==it.id){
                    TodoItemInlineEditor(
                        item = currentlyEditItem,
...
@Composable
fun TodoInputTextField(text:String,setText:(String)->Unit,modifier: Modifier) =
...
fun TodoItemEntryInput(onItemComplete: (TodoItem) -> Unit) {
    ...
    TodoItemInput(text, setText, icon, submit ,setIcon, isIconVisible){
...
/**
 * Providing slots for different types of buttons.
 */
@Composable
